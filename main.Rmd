...
```{r decomposition, results='asis', echo=FALSE, warning=FALSE}
...
ggplot() +
    geom_line(data = women, aes(x = date, y = value, color = "Ž"), linewidth = 1) +
    geom_line(data = men, aes(x = date, y = value, color = "M"), linewidth = 1) +
    labs(
        x = "Rok",
        y = "Nezaměstnanost (%)"
    ) +
...
Pandemie zasáhla všechny státy, ale státy s velkým cestovním ruchem a pohostinstvím, jako je **Nevada (30,6 %)**, **Michigan (22,6 %)** a **Hawaii (14,1s %)**, byly obzvláště postiženy. 
